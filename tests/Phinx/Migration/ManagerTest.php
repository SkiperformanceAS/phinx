...
class ManagerTest extends TestCase
{
    ...
    public function testPrintStatusMethod()
    {
        ...
        $this->assertRegExp('/up  20120111235330  2012-01-11 23:53:36.000000  2012-01-11 23:53:37.000000  TestMigration/', $outputStr);
        $this->assertRegExp('/up  20120116183504  2012-01-16 18:35:40.000000  2012-01-16 18:35:41.000000  TestMigration2/', $outputStr);
    }
    ...
    public function testPrintStatusMethodWithNamespace()
    {
        ...
        rewind($this->manager->getOutput()->getStream());
        $outputStr = stream_get_contents($this->manager->getOutput()->getStream());
        $this->assertRegExp('/up  20160111235330  2016-01-11 23:53:36.000000  2016-01-11 23:53:37.000000  Foo\\\\Bar\\\\TestMigration/', $outputStr);
        $this->assertRegExp('/up  20160116183504  2016-01-16 18:35:40.000000  2016-01-16 18:35:41.000000  Foo\\\\Bar\\\\TestMigration2/', $outputStr);
    }
    ...
    public function testPrintStatusMethodWithMixedNamespace()
    {
        ...
        $this->assertRegExp('/up  20120111235330  2012-01-11 23:53:36.000000  2012-01-11 23:53:37.000000  TestMigration/', $outputStr);
        $this->assertRegExp('/up  20120116183504  2012-01-16 18:35:40.000000  2012-01-16 18:35:41.000000  TestMigration2/', $outputStr);
        $this->assertRegExp('/up  20150111235330  2015-01-11 23:53:36.000000  2015-01-11 23:53:37.000000  Baz\\\\TestMigration/', $outputStr);
        $this->assertRegExp('/up  20150116183504  2015-01-16 18:35:40.000000  2015-01-16 18:35:41.000000  Baz\\\\TestMigration2/', $outputStr);
        $this->assertRegExp('/up  20160111235330  2016-01-11 23:53:36.000000  2016-01-11 23:53:37.000000  Foo\\\\Bar\\\\TestMigration/', $outputStr);
        $this->assertRegExp('/up  20160116183504  2016-01-16 18:35:40.000000  2016-01-16 18:35:41.000000  Foo\\\\Bar\\\\TestMigration2/', $outputStr);
    }
    ...
    public function testPrintStatusMethodWithMissingMigrations()
    {
        ...
        $this->assertRegExp('/\s*up  20120103083300  2012-01-11 23:53:36.000000  2012-01-11 23:53:37.000000  *\*\* MISSING \*\*' . PHP_EOL .
            '\s*up  20120815145812  2012-01-16 18:35:40.000000  2012-01-16 18:35:41.000000  Example   *\*\* MISSING \*\*' . PHP_EOL .
    ...
    public function testPrintStatusMethodWithMissingMigrationsWithNamespace()
    {
        ...
        // note that the order is important: missing migrations should appear before down migrations
        $this->assertRegExp('/\s*up  20160103083300  2016-01-11 23:53:36.000000  2016-01-11 23:53:37.000000  *\*\* MISSING \*\*' . PHP_EOL .
            '\s*up  20160815145812  2016-01-16 18:35:40.000000  2016-01-16 18:35:41.000000  Example   *\*\* MISSING \*\*' . PHP_EOL .
    ...
    public function testPrintStatusMethodWithMissingLastMigration()
    {
        ...
        // note that the order is important: missing migrations should appear before down migrations
        $this->assertRegExp('/\s*up  20120111235330  2012-01-16 18:35:40.000000  2012-01-16 18:35:41.000000  TestMigration' . PHP_EOL .
            '\s*up  20120116183504  2012-01-16 18:35:40.000000  2012-01-16 18:35:41.000000  TestMigration2' . PHP_EOL .
            '\s*up  20120120145114  2012-01-20 14:51:14.000000  2012-01-20 14:51:14.000000  Example   *\*\* MISSING \*\*/', $outputStr);
    }
    ...
    public function testPrintStatusMethodWithMissingLastMigrationWithNamespace()
    {
        ...
        // note that the order is important: missing migrations should appear before down migrations
        $this->assertRegExp('/\s*up  20160111235330  2016-01-16 18:35:40.000000  2016-01-16 18:35:41.000000  Foo\\\\Bar\\\\TestMigration' . PHP_EOL .
            '\s*up  20160116183504  2016-01-16 18:35:40.000000  2016-01-16 18:35:41.000000  Foo\\\\Bar\\\\TestMigration2' . PHP_EOL .
            '\s*up  20160120145114  2016-01-20 14:51:14.000000  2016-01-20 14:51:14.000000  Example   *\*\* MISSING \*\*/', $outputStr);
    }
    ...
    public function testPrintStatusMethodWithMissingLastMigrationWithMixedNamespace()
    {
        ...
        $this->assertRegExp(
            ...
            '\s*up  20160116183504  2016-01-16 18:35:40.000000  2016-01-16 18:35:41.000000  Foo\\\\Bar\\\\TestMigration2' . PHP_EOL .
            '\s*up  20170120145114  2017-01-20 14:51:14.000000  2017-01-20 14:51:14.000000  Example   *\*\* MISSING \*\*/',
            $outputStr
        );
    }
    ...
    public function testPrintStatusMethodWithMissingMigrationsAndBreakpointSet()
    {
        ...
        rewind($this->manager->getOutput()->getStream());
        $outputStr = stream_get_contents($this->manager->getOutput()->getStream());
        $this->assertRegExp('/up  20120103083300  2012-01-11 23:53:36.000000  2012-01-11 23:53:37.000000  *\*\* MISSING \*\*/', $outputStr);
        $this->assertRegExp('/BREAKPOINT SET/', $outputStr);
        $this->assertRegExp('/up  20120815145812  2012-01-16 18:35:40.000000  2012-01-16 18:35:41.000000  Example   *\*\* MISSING \*\*/', $outputStr);
    }
    ...
    public function testPrintStatusMethodWithDownMigrations()
    {
        ...
        rewind($this->manager->getOutput()->getStream());
        $outputStr = stream_get_contents($this->manager->getOutput()->getStream());
        $this->assertRegExp('/up  20120111235330  2012-01-16 18:35:40.000000  2012-01-16 18:35:41.000000  TestMigration/', $outputStr);
    ...
    public function testPrintStatusMethodWithDownMigrationsWithNamespace()
    {
        ...
        rewind($this->manager->getOutput()->getStream());
        $outputStr = stream_get_contents($this->manager->getOutput()->getStream());
        $this->assertRegExp('/up  20160111235330  2016-01-16 18:35:40.000000  2016-01-16 18:35:41.000000  Foo\\\\Bar\\\\TestMigration/', $outputStr);
